<template>
    <header>
        ...
        <!-- Componentes adicionais (Login e Carrinho) -->
...
.logo-search {
    ...
    align-items: center;
    margin-left: auto;
    /* Mover logo mais para a esquerda */
}
...
.search-bar input {
    ...
    /* Input maior */
    margin-left: 5px;
    /* Mover input 5px para a direita */
    margin-right: 40px;
}
...
.icon {
    ...
    gap: 20px;
    margin-left: auto;
    /* Mover ícones mais para a direita */
    margin-right: 70px;
    /* Mover ícones 40px para a esquerda */
}
